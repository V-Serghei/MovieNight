...
REM start "Friends.API" cmd /k "cd /d Services\Friends\Friends.API && dotnet run --launch-profile http"
REM start "Messages.API" cmd /k "cd /d Services\Messages\Messages.API && dotnet run --launch-profile http"
